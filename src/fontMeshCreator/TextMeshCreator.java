...
public class TextMeshCreator {
	...
	private TextMeshData createQuadVertices(Text text, List<Line> lines) {
		...
		double curserX = 0f; // text.Position.x / Game.instance.GameWindow.GetWidth();
		double curserY = 0f; // text.Position.y / Game.instance.GameWindow.GetHeight();
		...
		for (Line line : lines) {
			...
			curserX = 0; // text.Position.x / Game.instance.GameWindow.GetWidth();
